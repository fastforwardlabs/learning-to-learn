...
from maml.utils import tensors_to_device, compute_accuracy, compute_precision
...
class ModelAgnosticMetaLearning(object):
    ...
    def get_outer_loss(self, batch):
        ...
        for task_id, (train_inputs, train_targets, test_inputs, test_targets) \
            ...
            if is_classification_task:
                ...
                results['precision_after'][task_id] = compute_precision(
                    test_logits, test_targets)
    ...
    def adapt(self, inputs, targets, is_classification_task=None,
        ...
        for step in range(num_adaptation_steps):
            ...
            if (step == 0) and is_classification_task:
                ...
                results['precision_before'] = compute_precision(logits, targets)
    ...
    def train(self, dataloader, max_batches=500, verbose=True, **kwargs):
        mean_outer_loss, mean_accuracy, mean_precision, count = 0., 0., 0., 0
        ...
        for results in self.train_iter(dataloader, max_batches=max_batches):
            ...
            if 'accuracies_after' in results:
                mean_accuracy += (np.mean(results['accuracies_after'])
                        - mean_accuracy) / count
                mean_precision += (np.mean(results['precision_after'])
                        - mean_precision) / count
        ...
        if 'accuracies_after' in results:
            ...
            mean_results['precision_after'] = mean_precision
        return mean_results
